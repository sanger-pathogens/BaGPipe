#!/usr/bin/env python3
"""
screening_summaries.py - Pure Python (no pandas)
"""
...
def summarise(rtab, annotated_kmers, outdir):
    ...
    with open(outdir / "screening_per_sample.tsv", "w") as f:
    ...
    with open(outdir / "screening_per_unitig.tsv", "w") as f:
    ...
    with open(outdir / "screening_per_gene.tsv", "w") as f:
...
def main():
    ...
    ap.add_argument("--outdir", default="screening")
    args = ap.parse_args()
